...
UUID = os.environ.get('UUID', 'dae16121-2b47-4122-8060-99c99c0020a2')
...
NEZHA_KEY = os.environ.get('NEZHA_KEY', '4uGdCozN89YGCq2CeQ')
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.future13800.eu.org')                   # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNjc0MmMxNDI5ZDE4OTA3NjMzZjMyZjQ2MWM5MzUwOWMiLCJ0IjoiNzk5Y2JhMTQtZGE3ZS00NzY5LTliZGItNWE2Y2UwZGEwYWIwIiwicyI6IlpHVmpZakZqT0RjdE1tTm1OaTAwTW1VMExXSmhPV0V0WmpWak9ERmlPV1EwTVROaSJ9')                      # 国定隧道json或token，留空即启用临时隧道
